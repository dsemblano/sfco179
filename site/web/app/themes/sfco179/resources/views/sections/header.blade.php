  ...
  <nav class="nav-primary container lg:px-24">
    ...
    <div id="mobile-menu" class="flex flex-wrap order-3 ml-8 md:hidden">
      ...
      <button id="button-sandwich" aria-label="Botão menu sanduíche" data-collapse-toggle="mobile-menu-3" type="button"
        class="inline-flex items-center p-2 text-sm text-white rounded-lg md:hidden" aria-controls="mobile-menu-3"
        aria-expanded="false">
    ...
    <div class="hidden order-4 md:flex md:order-2 justify-between items-center w-full " id="mobile-menu-3">
      ...
      {!! wp_nav_menu(['theme_location' => 'primary_navigation', 'menu_class' => 'flex flex-col py-2 text-white
