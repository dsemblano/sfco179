    ...
    <div class="bg-homechild flex justify-center items-center min-h-screen">
        <header class="mx-auto container flex justify-center">
            <div class="">
                ...
                <div class="flex social-icons justify-around text-white relative mt-14">
                    ...
                    <a class="fill-current" href="mailto:fale@sfco179.com.br" target="_blank" aria-label="Link para Email">
